...
| 3 | **Role Card template, with definitions** | Describing a role: the single assistant after the debrief, or each role after decomposition (README Chapter 4) | [role-card-template.md](role-card-template.md) |
...
| 5 | **Why Agent Design Studio?** ([open the app](https://agentstudio.aroughidea.com/)) | Before teams test a role card as a working prompt (README Chapter 5) | [agent-design-studio.md](agent-design-studio.md) |
...
| Reflection & Debrief | 3 minutes in teams, then about 3 minutes per team, rotating: Assistants, then Users, then Observers reading selected Post-its | README Chapter 3, Phase 2 |
...
| Design Practice Question | "How will you present the design of your agent?" A presentation of the design decisions, why they were made, and how they were tested. | README Chapter 5, Presenting Your Agent |
| Review | Three design artifacts to discuss and critique: Design Intent, System Diagram, Design Quals | README Chapter 5, Presenting Your Agent |
...
**Follow-up exercise: decomposition.** Role decomposition (README Chapter 4) comes after this session. Open it by asking each team:
...
The person playing the User doesn't make up a character. Each Goal Card asks them to *think of a time* they needed to do this. The moment doesn't have to be profound. Being late to class, or a job they wanted to leave but didn't, is enough. Leaning into that memory tells them who the letter is for and what happened, so they can answer the Assistant's questions honestly without improvising.
...
The enactment is **a single 10-minute run**. At minute 5 the User "suddenly remembers" the Stage 2 notes, and at minute 8 the Stage 3 note. The reveals happen inside the same run, not in separate runs.
